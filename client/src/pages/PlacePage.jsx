...
import BookingWidget from "../BookingWodget";
    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-4 px-8 pt-8">
            ...
            <div className="relative">
                ...
                <button onClick={() => setShowAllPhotos(true)} className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow shadow-black">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="mt-8 mb-8 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
                <div>
                    <div className="my-4">
                    ...
                    Max number og guests: {place.maxGuests}
            ...
            <div className="bg-white -mx-0 px-8 py-8 border-t">
                <div>
