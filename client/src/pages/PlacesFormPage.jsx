    ...
    return (
                <div>
                    ...
                    <form onSubmit={savePlace}>
                        {preInput('Title', 'Title for your place. shoud be short and catchy as in advertisem')}
                        <input type="text" value={title} onChange={ev => setTitle(ev.target.value)} placeholder="title, for example: My lovely apt" />
                        {preInput('Address', 'Adress to this place')}
                        <input type="text"  value={address} onChange={ev => setAddress(ev.target.value)} placeholder="address" />
                        {preInput('Photos',  'more = better')}
                        <PhotosUploader addedPhotos={addedPhotos} onChange={setAddedPhotos}/>
                        {preInput('Description', 'Description in the place')}
                        <textarea  value={description} onChange={ev => setDescrition(ev.target.value)}/>
